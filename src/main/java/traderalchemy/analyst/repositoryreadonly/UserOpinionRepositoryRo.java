...
public class UserOpinionRepositoryRo {
    ...
    public List<UserOpinionPo> findAllToBeAnalysed(String strategyClassName) {
        return findAllToBeAnalysed(strategyClassName, ZonedDateTime.now().minusMonths(3).plusMinutes(1));
    }

    public List<UserOpinionPo> findAllToBeAnalysed(String strategyClassName, ZonedDateTime createAfter) {
        if (createAfter == null) {
