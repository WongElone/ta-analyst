...
public class ArticleRepositoryRo {
    ...
    public List<ArticlePo> findAllToBeAnalysed(String strategyClassName) {
        return findAllToBeAnalysed(strategyClassName, ZonedDateTime.now().minusDays(7).plusMinutes(1));
    } 

    public List<ArticlePo> findAllToBeAnalysed(String strategyClassName, ZonedDateTime publishAfter) {
