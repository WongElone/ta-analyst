...
public class FlashNewsRepositoryRo {
    ...
    public List<FlashNewsPo> findAllToBeAnalysed(String strategyClassName) {
        return findAllToBeAnalysed(strategyClassName, ZonedDateTime.now().minusDays(1).plusMinutes(1));
    } 

    public List<FlashNewsPo> findAllToBeAnalysed(String strategyClassName, ZonedDateTime publishAfter) {
